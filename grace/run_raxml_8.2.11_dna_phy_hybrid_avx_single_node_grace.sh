...
########## INPUTS ##########
# sample data runtime with this script = 18 hrs
...
########## OUTPUTS #########
working_dir=`pwd`/working_singlenode            # RAxML only accepts absolute path names, not relative ones
[ -d $working_dir ] || mkdir $working_dir       # make working_dir if it doesn't exist

output_suffix="${model}_${algorithm}-hybrid-avx-singlenode"
