...
########## INPUTS ##########
sra_accession_number='SRR15326782'

########## OUTPUTS ##########
# use default outputs

################################### COMMANDS ###################################
# use --split-files for paired end data; remove --split-files if library is single end
fastq-dump -F -I --gzip $sra_accession_number --split-files
